  ...
  try {
    ...
    if (user.dwollaCustomerId) {
      try {
        ...
        console.error("Dwolla funding source failed (continuing without it):", dwollaError);
      }
    } else {
      console.warn("User has no dwollaCustomerId — skipping Dwolla funding source. Transfers will be disabled for this bank.");
    }
